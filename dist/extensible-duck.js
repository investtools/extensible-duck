...
/***/ function(module, exports, __webpack_require__) {
	...
	function buildTypes(namespace, store, types) {
	  return _lodash2.default.zipObject(types, _lodash2.default.map(types, function (type) {
	...
	var Duck = function () {
	  function Duck(options) {
	    ...
	    _lodash2.default.each(consts, function (values, name) {
	      _this[name] = _lodash2.default.zipObject(values, values);
	    });
	    this.types = buildTypes(namespace, store, types);
	    this.initialState = _lodash2.default.isFunction(initialState) ? initialState(this) : initialState;
	  ...
	  _createClass(Duck, [{
	    ...
	    value: function reducer(state, action) {
	      if (_lodash2.default.isUndefined(state)) {
	    ...
	    value: function extend(options) {
	      ...
	      if (_lodash2.default.isFunction(options.initialState)) {
	        initialState = function initialState(duck) {
	          return options.initialState(duck, _this2.initialState);
	        };
	      } else if (_lodash2.default.isUndefined(options.initialState)) {
	      ...
	      return new Duck(_extends({}, parent, options, {
	        ...
	        consts: _lodash2.default.mergeWith({}, parent.consts, options.consts, function (a, b) {
	        ...
	        reducer: function reducer(state, action, duck) {
	          ...
	          if (_lodash2.default.isUndefined(options.reducer)) {
	            return state;
	          } else {
